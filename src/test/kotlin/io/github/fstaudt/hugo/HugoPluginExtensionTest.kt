...
class HugoPluginExtensionTest {
    companion object {
        const val WINDOWS_ARCHIVE = "gohugoio/hugo/releases/download/v0.109.0/hugo_extended_0.109.0_windows-amd64.zip"
        const val LINUX_ARCHIVE = "gohugoio/hugo/releases/download/v0.109.0/hugo_extended_0.109.0_linux-amd64.tar.gz"
        const val MAC_OS_ARCHIVE = "gohugoio/hugo/releases/download/v0.109.0/hugo_extended_0.109.0_darwin-universal.tar.gz"
    }
