...
class HugoPluginExtensionTest {
    companion object {
        const val WINDOWS_ARCHIVE = "gohugoio/hugo/releases/download/v0.120.3/hugo_extended_0.120.3_windows-amd64.zip"
        const val LINUX_ARCHIVE = "gohugoio/hugo/releases/download/v0.120.3/hugo_extended_0.120.3_linux-amd64.tar.gz"
        const val MAC_OS_ARCHIVE = "gohugoio/hugo/releases/download/v0.120.3/hugo_extended_0.120.3_darwin-universal.tar.gz"
    }
