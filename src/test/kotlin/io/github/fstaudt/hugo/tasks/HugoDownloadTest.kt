...
class HugoDownloadTest {
    companion object {
        ...
        const val WINDOWS_ARCHIVE = "$HUGO_PATH/v0.163.3/hugo_extended_0.163.3_windows-amd64.zip"
        const val LINUX_ARCHIVE = "$HUGO_PATH/v0.163.3/hugo_extended_0.163.3_linux-amd64.tar.gz"
        const val MAC_OS_ARCHIVE = "$HUGO_PATH/v0.163.3/hugo_extended_0.163.3_darwin-universal.tar.gz"
