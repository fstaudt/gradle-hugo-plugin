...
class HugoDownloadTest {
    companion object {
        ...
        const val WINDOWS_ARCHIVE = "$HUGO_PATH/v0.152.2/hugo_extended_0.152.2_windows-amd64.zip"
        const val LINUX_ARCHIVE = "$HUGO_PATH/v0.152.2/hugo_extended_0.152.2_linux-amd64.tar.gz"
        const val MAC_OS_ARCHIVE = "$HUGO_PATH/v0.152.2/hugo_extended_0.152.2_darwin-universal.tar.gz"
